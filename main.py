...
bot = telebot.TeleBot('6743419363:AAEtslsmt3WMMecYi6Nz6kcHZFpJ_AVXirw') #<- यहां बोट टोकन डालो ।

# Admin user IDs
admin_id = ["6929246588"]  #⬅️ यहां यूज़र ID ✔️
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, port, and time
            ...
            if time > 240:
                ...
                response = f"🚀𝐀𝐭𝐭𝐚𝐜𝐤 𝐨𝐧 {target}:{port} \n𝐂𝐨𝐦𝐩𝐞𝐥𝐞𝐭𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲❤"
        else:
            response = "𝐋𝐚𝐮𝐧𝐜𝐡 𝐚 𝐚𝐭𝐭𝐚𝐜𝐤 𝐮𝐬𝐢𝐧𝐠💣 :- /bgmi <target> <port> <time> "  # Updated command syntax


    else:
        response = "𝐘𝐨𝐮𝐫 𝐚𝐫𝐞 𝐧𝐨𝐭 𝐚𝐩𝐩𝐫𝐨𝐯𝐞𝐝 𝐭𝐨 𝐦𝐲 𝐛𝐨𝐭 😼"
...
def show_help(message):
 ...
 /bgmi : 𝐭𝐨 𝐚𝐭𝐭𝐚𝐜𝐤 𝐬𝐞𝐫𝐯𝐞𝐫. 
 /rules : 𝐅𝐨𝐥𝐥𝐨𝐰 𝐫𝐮𝐥𝐞𝐬.
 /mylogs : 𝐂𝐡𝐞𝐜𝐤 𝐲𝐨𝐮𝐫 𝐚𝐭𝐭𝐚𝐜𝐤𝐬 .
 /plan : 𝐁𝐮𝐲 𝐟𝐫𝐨𝐦 @tg_tamizh/@DINI_IOS ✓\n 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥 𝐜𝐡𝐚𝐧𝐧𝐞𝐥: https://t.me/+ow-jf3Xku7dlYmY9
 

 𝐓𝐨 𝐬𝐞𝐞 𝐚𝐝𝐦𝐢𝐧 𝐜𝐨𝐦𝐦𝐚𝐧𝐝𝐬 :
 /admincmd : 𝐎𝐧𝐥𝐲 𝐟𝐨𝐫 𝐚𝐝𝐦𝐢𝐧𝐬.
 '''
...
def welcome_start(message):
    ...
    response = f"𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝐓𝐨𝐝𝐨 𝐝𝐝𝐨𝐬 𝐛𝐨𝐭 : 𝐔𝐬𝐞 /help 𝐭𝐨 𝐞𝐱𝐩𝐥𝐨𝐫𝐞 𝐭𝐡𝐞 𝐛𝐨𝐭!! \n\n𝐁𝐮𝐲 𝐚𝐜𝐜𝐞𝐬𝐬 𝐟𝐫𝐨𝐦 @tg_tamizh 𝐇𝐚𝐯𝐞 𝐚 𝐧𝐢𝐜𝐞 𝐝𝐚𝐲😅❤"
    bot.reply_to(message, response)
...
def welcome_plan(message):
    user_name = message.from_user.first_name
    response = f'''{user_name}, ʙᴜʏ ғʀᴏᴍ @tg_tamizh
